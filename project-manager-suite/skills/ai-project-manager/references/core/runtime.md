...
- S3 正式开发计划：[`../../../delivery-planner/SKILL.md`](../../../delivery-planner/SKILL.md)
...
10. 命中 S3 并由 `delivery-planner` 产出或更新正式开发计划后，主入口必须把正式计划入口、当前活跃任务与下一步动作同步回 `execution-plan.md`；不得把完整 Phase / Task 正文直接塞进执行计划驾驶舱
11. S3 驾驶舱同步时，只能读取正式计划顶部固定的“驾驶舱摘要”区块；不得从整份计划正文自由总结
