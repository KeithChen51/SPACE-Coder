...
|------|-----------------------|------|
| `methodology.md` | `../test-case-chief/knowledge/methodology.md` | 5 种测试覆盖维度框架（等价类+边界 / 决策表 / 状态迁移 / 场景法 / 错误推测）——作为"覆盖维度思维框架"用来审验收条目组是否按合理维度覆盖 |
...
1. 读 `../test-case-chief/knowledge/methodology.md`，建立本轮审评的**覆盖维度框架**——5 种设计法（等价类+边界 / 决策表 / 状态迁移 / 场景法 / 错误推测）
