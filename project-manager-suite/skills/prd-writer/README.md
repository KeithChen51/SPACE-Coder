...
面向 AI 编程的 PRD 撰写 Skill。基于已确认的页面代码和技术地基（术语表、Schema、API），产出功能列表、主文档和按区块拆分的子文档。
...
| 主文档 | 全局索引枢纽，引用所有上游产物，索引所有子 PRD |
| 子文档(N份) | 按区块拆分，字段级可追溯，与主文档双向引用 |

## 核心原则

- PRD 是 AI 编程的规格说明书，不是给人看的传统文档
- 术语/Schema/API 只引用 foundation-builder 产物，不重新定义
- 子 PRD 边界严格，字段/接口/管理页不越界
