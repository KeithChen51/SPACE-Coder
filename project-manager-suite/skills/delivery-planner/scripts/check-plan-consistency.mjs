 ...
 * Traceability:
 *   Rule sources:
 *     - skills/delivery-planner/SKILL.md (S4 前计划一致性校验)
 *     - skills/ai-project-manager/references/core/runtime.md (S4 调度门禁)
 *
 * Purpose:
...
function printUsage() {
    console.log(
        'Usage: node <suite-path>/skills/delivery-planner/scripts/check-plan-consistency.mjs <main-delivery-plan-file> [--json]'
    );
}
