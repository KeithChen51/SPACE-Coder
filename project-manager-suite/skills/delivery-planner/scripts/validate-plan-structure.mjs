 ...
 *
 * Usage:
 *   node <suite-path>/skills/delivery-planner/scripts/validate-plan-structure.mjs <main-delivery-plan-file> [--json]
 *
 * Exit codes:
 *   0 – all checks passed
...
function printUsage() {
    console.log(
        'Usage: node <suite-path>/skills/delivery-planner/scripts/validate-plan-structure.mjs <main-delivery-plan-file> [--json]'
    );
}
