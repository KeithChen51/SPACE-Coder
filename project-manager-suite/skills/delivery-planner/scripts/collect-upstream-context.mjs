 ...
 * Traceability:
 *   Rule sources:
 *     - skills/delivery-planner/SKILL.md (Step 0.5)
 *     - skills/delivery-planner/references/source-loading-order.md (Section 十)
 *   Pipeline naming conventions:
 *     - PIPELINE.md (prd-writer / foundation-builder product naming)
 *
 * Location:
 *   skills/delivery-planner/scripts/collect-upstream-context.mjs
 ...
 *
 * Usage:
 *   node <suite-path>/skills/delivery-planner/scripts/collect-upstream-context.mjs <hostRoot> [--docs-dir <rel-path>] [--json] [--verbose]
 *
 * Exit codes:
...
function printUsage() {
    console.log(
        'Usage: node <suite-path>/skills/delivery-planner/scripts/collect-upstream-context.mjs <hostRoot> [--docs-dir <rel-path>] [--json] [--verbose]'
    );
    console.log('');
    console.log('Options:');
