...
// Repository visual evaluation baselines are source-only and are not part of this release.
...
const FILE_SPECS = [
  ...
  { source: "vendor/runtime-libs/RUNTIME.json", destination: "visualizations/lieflat/runtime/RUNTIME.json" },
  { source: "vendor/runtime-libs/chart.umd.min.js", destination: "visualizations/lieflat/runtime/chart.umd.min.js" },
  { source: "vendor/runtime-libs/chart.LICENSE.md", destination: "visualizations/lieflat/runtime/chart.LICENSE.md" },
  { source: "vendor/runtime-libs/echarts.min.js", destination: "visualizations/lieflat/runtime/echarts.min.js" },
  { source: "vendor/runtime-libs/echarts.LICENSE", destination: "visualizations/lieflat/runtime/echarts.LICENSE" },
  { source: "vendor/runtime-libs/echarts.NOTICE", destination: "visualizations/lieflat/runtime/echarts.NOTICE" },
  ...
  { source: "templates/brand-attribution/formal-standard-powered-by-mask.svg", destination: "assets/brand/space-ai-native/formal-standard-powered-by-mask.svg" },
  { source: "templates/brand-attribution/formal-standard-ai-mask.svg", destination: "assets/brand/space-ai-native/formal-standard-ai-mask.svg" },
  { source: "templates/brand-attribution/formal-standard-native-mask.svg", destination: "assets/brand/space-ai-native/formal-standard-native-mask.svg" },
  { source: "templates/brand-attribution/formal-compact-powered-by-mask.svg", destination: "assets/brand/space-ai-native/formal-compact-powered-by-mask.svg" },
  { source: "templates/brand-attribution/formal-compact-ai-mask.svg", destination: "assets/brand/space-ai-native/formal-compact-ai-mask.svg" },
  { source: "templates/brand-attribution/formal-compact-native-mask.svg", destination: "assets/brand/space-ai-native/formal-compact-native-mask.svg" },
  ...
  { source: "templates/brand-attribution/formal-standard-powered-by-mask.svg", destination: "runtime/brand-attribution/formal-standard-powered-by-mask.svg" },
  { source: "templates/brand-attribution/formal-standard-ai-mask.svg", destination: "runtime/brand-attribution/formal-standard-ai-mask.svg" },
  { source: "templates/brand-attribution/formal-standard-native-mask.svg", destination: "runtime/brand-attribution/formal-standard-native-mask.svg" },
  { source: "templates/brand-attribution/formal-compact-powered-by-mask.svg", destination: "runtime/brand-attribution/formal-compact-powered-by-mask.svg" },
  { source: "templates/brand-attribution/formal-compact-ai-mask.svg", destination: "runtime/brand-attribution/formal-compact-ai-mask.svg" },
  { source: "templates/brand-attribution/formal-compact-native-mask.svg", destination: "runtime/brand-attribution/formal-compact-native-mask.svg" },
...
const LEGACY_V09_SOURCE_OVERRIDES = Object.freeze({
  "visualizations/lieflat/runtime/RUNTIME.json": "templates/visualization-lieflat/runtime/RUNTIME.json",
  "visualizations/lieflat/runtime/chart.umd.min.js": "templates/visualization-lieflat/runtime/chart.umd.min.js",
  "visualizations/lieflat/runtime/chart.LICENSE.md": "templates/visualization-lieflat/runtime/chart.LICENSE.md",
  "visualizations/lieflat/runtime/echarts.min.js": "templates/visualization-lieflat/runtime/echarts.min.js",
  "visualizations/lieflat/runtime/echarts.LICENSE": "templates/visualization-lieflat/runtime/echarts.LICENSE",
  "visualizations/lieflat/runtime/echarts.NOTICE": "templates/visualization-lieflat/runtime/echarts.NOTICE",
});
const LEGACY_V09_BASE_SOURCES = Object.freeze(Object.fromEntries(
  FILE_SPECS
    ...
    .map((spec) => [spec.destination, LEGACY_V09_SOURCE_OVERRIDES[spec.destination] ?? spec.source]),
));
const LEGACY_V09_REACT_SOURCES = Object.freeze({
  ...
  "checks/visual-baselines/desktop.png": "source-only-visual-baselines/desktop.png",
  "checks/visual-baselines/narrow.png": "source-only-visual-baselines/narrow.png",
  "checks/visual-baselines/mobile.png": "source-only-visual-baselines/mobile.png",
  "checks/visual-baselines/reduced-motion.png": "source-only-visual-baselines/reduced-motion.png",
...
function renderTemplate(spec, source, context) {
  ...
  if (spec.source.startsWith("templates/visualization-lieflat/") && extname(spec.source) === ".html") {
    ...
    rendered = rendered.replaceAll("../../vendor/runtime-libs/", "runtime/");
  }
  return rendered;
}
